...
Вместо того чтобы создавать новую горутину на каждую задачу (что может
привести к исчерпанию ресурсов при резком скачке нагрузки), мы создаем
фиксированное количество "воркеров" (горутин), которые обрабатывают
задачи из общей очереди (канала).
